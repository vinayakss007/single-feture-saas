...
> What has to happen after someone dies, in what order. State, religion, assets, will status, and heir details in, chronological checklist with timelines, documents, religion-specific succession law, and NRI complications out. Not a generic grief resource — a precise legal and administrative checklist for this religion, these assets, this state, with documents needed at each step.

**Topics** — Legal tools, Artificial Intelligence, SaaS, Developer Tools, API
...
> Show HN: EstateAdmin – what has to happen after someone dies, in what order
...
> State, religion, assets, will status, and heir details in, chronological checklist with timelines, documents, religion-specific succession law, and NRI complications out.
>
> Not a generic grief resource — a precise legal and administrative checklist for this religion, these assets, this state, with documents needed at each step.
>
> Built it because what has to happen after someone dies, in what order is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
