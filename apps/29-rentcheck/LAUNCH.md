...
> Show HN: RentCheck – is this rent fair for this area, and what to negotiate
...
> Property details and quoted rent in, fair range and negotiation points out.
>
> Not a listing site — a second opinion on the number someone quoted you, with the specific points to negotiate on and the clauses to add to the agreement.
>
> Built it because is this rent fair for this area, and what to negotiate is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
