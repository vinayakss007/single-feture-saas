...
> How much sleep you owe yourself, and when to repay it. Sleep log in, cumulative debt, severity, recovery plan, and tonight's bedtime out. Not a sleep tracker — a debt calculator that tells you exactly how much you owe, how long recovery will take with realistic diminishing returns, and what time to go to bed tonight.

**Topics** — Health & wellness, Artificial Intelligence, SaaS, Developer Tools, API
...
> Show HN: SleepDebt – how much sleep you owe yourself, and when to repay it

**Comment** — lead with the technical decision, not the benefit

> Cumulative debt computation from bedtime/wake pairs against personal target, severity classification (manageable/concerning/chronic), recovery modelling with diminishing returns, consecutive short-night detection, and optimal bedtime recommendation.
>
> Not a sleep tracker — a debt calculator that tells you exactly how much you owe, how long recovery will take with realistic diminishing returns, and what time to go to bed tonight.
>
...
> Sleep log in, cumulative debt, severity, recovery plan, and tonight's bedtime out.
>
> Not a sleep tracker — a debt calculator that tells you exactly how much you owe, how long recovery will take with realistic diminishing returns, and what time to go to bed tonight.
>
> Built it because how much sleep you owe yourself, and when to repay it is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
