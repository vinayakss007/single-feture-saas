...
> Find the leak from your water meter readings. Meter readings over several days and household size in, daily consumption analysis, leak detection, litres lost per day, monthly cost, and likely leak type out. Not a plumber guessing — data-driven leak detection from your meter readings that identifies the type of leak and what it costs you per month.

**Topics** — Utility tools, Artificial Intelligence, SaaS, Developer Tools, API
...
> Show HN: WaterLeak – find the leak from your water meter readings
...
> Meter readings over several days and household size in, daily consumption analysis, leak detection, litres lost per day, monthly cost, and likely leak type out.
>
> Not a plumber guessing — data-driven leak detection from your meter readings that identifies the type of leak and what it costs you per month.
>
> Built it because find the leak from your water meter readings is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
