...
- [ ] Deployed and reachable on a real domain (`packlist.abetworks.in`)
...
> The packing list for this trip, this weather, this many days. Destination type, duration, weather, and activities in, complete categorised packing list with quantities and bag space estimate out. Not a generic travel checklist — a packing calculator that gives exact quantities for this trip, this weather, this many days, with these activities, in this bag.
...
> Show HN: PackList – the packing list for this trip, this weather, this many days
...
> Destination type, duration, weather, and activities in, complete categorised packing list with quantities and bag space estimate out.
>
> Not a generic travel checklist — a packing calculator that gives exact quantities for this trip, this weather, this many days, with these activities, in this bag.
>
> Built it because the packing list for this trip, this weather, this many days is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
