...
- [ ] Deployed and reachable on a real domain (`rtidraft.abetworks.in`)
...
> The RTI application that gets answered, not ignored. Authority type, department, and information request in, formatted RTI application with legal citations and fee details out. Not a legal advice tool — a properly formatted RTI application generator that gets the technicalities right so your valid question actually gets answered.
...
> Show HN: RTIDraft – the rti application that gets answered, not ignored
...
> Authority type, department, and information request in, formatted RTI application with legal citations and fee details out.
>
> Not a legal advice tool — a properly formatted RTI application generator that gets the technicalities right so your valid question actually gets answered.
>
> Built it because the RTI application that gets answered, not ignored is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
