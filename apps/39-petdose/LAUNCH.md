...
- [ ] Deployed and reachable on a real domain (`petdose.abetworks.in`)
...
> What your pet weighs and when each dose is due. Species, breed, weight, and last treatment dates in, next due dates with weight-based dosing out. Not a pet health app — a preventative care calculator that tells you exactly what dose, which product, and when it is due based on your pet's actual weight and schedule.

**Topics** — Pet care, Artificial Intelligence, SaaS, Developer Tools, API
...
> Show HN: PetDose – what your pet weighs and when each dose is due
...
> Species, breed, weight, and last treatment dates in, next due dates with weight-based dosing out.
>
> Not a pet health app — a preventative care calculator that tells you exactly what dose, which product, and when it is due based on your pet's actual weight and schedule.
>
> Built it because what your pet weighs and when each dose is due is something I kept doing by hand. Free tier, no signup, nothing stored. Genuinely interested in whether the approach holds up on your data — happy to be told it does not.
